...
export default function LoginPage() {
  ...
  const handleLogin = async (
    ...
    try {
      ...
      // Jika input sudah berupa email,
      // gunakan email tersebut.
      //
      // Jika input hanya username,
      // tambahkan domain BPS.
      const loginEmail =
        cleanInput.includes('@')
          ? cleanInput
      ...
      const {
        ...
        await supabase
          .from('profiles')
          .select(
            'id, role, status, full_name, email'
          )
          .eq('id', user.id)
          .single();
      ...
      if (
        ...
        setErrorMsg(
          'Akun Anda masih menunggu persetujuan admin. Silakan tunggu hingga akun disetujui.'
        );
      ...
      if (
        ...
        setErrorMsg(
          'Status akun tidak valid. Silakan hubungi administrator.'
        );
                  ...
                  {showPassword ? (
                    ...
                    >
                      ...
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M2.036 12c1.274 4.057 5.065 7 9.542 7 4.477 0 8.268-2.943 9.542-7-1.274-4.057-5.064-9.542-9.542-9.542-4.477 0-8.268 2.943-9.542 7Z"
                      />
